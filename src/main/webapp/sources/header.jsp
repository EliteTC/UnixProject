	...
	<div class="container-fluid">
		...
		<div class="navbar-collapse collapse">
			<ul class="nav navbar-nav navbar-center">
				<li ><a href="/" target="_top"><h4 class=" fontsize">Home</h4></a></li>
...
<div class="container modal col-sm-12 col-xs-12" id="registrationForm">
	...
	<form class="center modal-content">
		...
		<button id="adduser" type="submit" class="paddingB form-control btn btn-success btn-lg text-center">Join now</button>
